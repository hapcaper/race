...
<div class="main-login col-sm-4 col-sm-offset-4">
    <div class="logo">中原工学院<i class="clip-clip"></i>竞赛管理平台
    </div>
    <!-- start: LOGIN BOX -->
    <div class="box-login">
                    ...
                    <div class="tab-content">
                        <div id="panel_tab_example1" class="tab-pane active">
							...
							<span class="input-icon">
								<input type="text" class="form-control" name="username" placeholder="学生帐号">
                        ...
                        <div id="panel_tab_example2" class="tab-pane">
                            <form class="form-login2" action="login.do?who=teacher" method="post">
                                ...
                                <fieldset>
                                    <div class="form-group">
							<span class="input-icon">
								<input type="text" class="form-control" name="username" placeholder="教师帐号">
								<i class="fa fa-user"></i> </span>
                                    </div>
                                    <div class="form-group form-actions">
							<span class="input-icon">
								...
								<a class="forgot" href="#">
                                    ...
                                    <div class="form-actions">
                                        <label for="remember" class="checkbox-inline">
                                            <input type="checkbox" class="grey remember" id="remember2" name="remember">
                                            记住我
                                        </label>
                                        <button type="submit" class="btn btn-bricky pull-right">
                                            登录 <i class="fa fa-arrow-circle-right"></i>
