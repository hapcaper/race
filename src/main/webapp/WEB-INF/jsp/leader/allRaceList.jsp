        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="page-header">
                    <h3 class="center">所有赛事<small>（当前学期:${term.term+2015 }）</small>
                    </h3>
                </div>
                ...
                <table class="table table-hover" id="sample-table-1">
                    ...
                    <c:forEach items="${racelist }" var="race" varStatus="loop">
                        <tr>
                            ...
                            <td class="hidden-xs">
                                <c:if test="${race.progress == 1 }">赛事进行中</c:if>
                                <c:if test="${race.progress == 2 }">赛事已完成</c:if>
                            </td>
                            <td class="hidden-xs">
                                <c:if test="${race.progress == 1 }"><a href="manage/toAward.do?rid=${race.id} ">审核</a></c:if>
                                <c:if test="${race.progress == 2 }">
                                    ...
                                    <c:if test="${race.result == 4 }">其他</c:if>
                                </c:if>
                            </td>
                            <td><a href="manage/toRaceDetail.do?rid=${race.id }">详情</a></td>
                        </tr>
                    </c:forEach>
