			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="page-header">
						...
						<br>
						<h3 class="center">
							所有老师的赛事工作量<small>（当前学期:${term.term+2015 }）</small>
						</h3>
					</div>
				...
				<form method="get" id="frm" class="form-inline"
						action="manage/queryTeacherWorkList.do">
						<label>选择学期: 
				...
				<div class="panel-body">
					<table class="table table-hover" id="sample-table-1">
						<thead>
							<tr>
								<th>教师名称</th>
								<th class="hidden-xs">目前所有工作量</th>

							</tr>
						</thead>
						<tbody>
							
							<c:forEach items="${tlist }" var="teacher" varStatus="loop">
							<tr>
								<td>${teacher.tname }</td>
								<td class="hidden-xs">${wlist[loop.count-1] }</td>
								</tr>
							</c:forEach>
					...
					<div class="form-group">
						<div class="col-sm-2 col-sm-offset-8">
							<a href="manage/endTerm.do">
								<button data-style="expand-right"
									class="btn btn-teal ladda-button">
									<span class="ladda-label"> 结束当前学期 </span> <i
