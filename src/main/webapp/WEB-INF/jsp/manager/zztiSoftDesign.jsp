				...
				<div class="row">
					<div id="step-1">
						<div class="form-group">
							<label class="col-sm-3 control-label"> 赛事名称 <span
						...
						<div class="form-group">
							<label class="col-sm-3 control-label"> 参赛形式 <span
								class="symbol required"></span>
							</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label"> 赛事级别 <span
								class="symbol required"></span>
							</label>
							<div class="col-sm-7">
								<select class="form-control" id="country" name="country">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="col-sm-6">
									<input type="submit" value="继续" class="btn btn-blue btn-block">
								</div>
								<div class="col-sm-6">
