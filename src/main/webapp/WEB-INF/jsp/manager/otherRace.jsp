			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="page-header">
						<br><h3 class="center">请填写赛事信息</h3>
					</div>
				</div>
				<!-- end: PAGE HEADER -->
				<!-- start: PAGE CONTENT enctype="multipart/form-data"-->
				<form role="form" class="form-horizontal"
					 action="manage/toOtherSelectProject.do"
					method="post">
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" placeholder="赛事名" id="form-field-1" 
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-field-6">
							赛事级别<span class="symbol required"></span>
						</label>
						<div class="col-sm-4">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-field-6">
							参赛形式<span class="symbol required"></span>
						</label>
						<div class="col-sm-4">
							<div class="" data-role="fieldcontain">
								...
								<select  name="kind"
									class="form-control search-select">
									<option value="1">作品型</option>
									<option value="2">考试型</option>
								</select>
								<br>
								<br>
