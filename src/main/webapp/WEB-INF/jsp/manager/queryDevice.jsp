...
function submitForm(currenPage){
	...
	if(currenPage<=1){
	 ...
	 document.getElementById("condition").action="manage/queryDevice.do?currenPage="+currenPage;
	...
	--%><div class="main-container">
		...
		<div class="main-content">
			...
			<div class="container">
				...
				<!-- end: PAGE HEADER -->
				<form id="condition" role="form" class="form-horizontal" action="manage/allDeviceQueryDevice.do" method="post">
					<div class="row">
					...
					<div class="col-md-12">
						...
						<table class="table table-hover" id="sample-table-1">
							...
							<c:forEach items="${deviceList }" var="device" varStatus="loop">
								...
								<tr>
									<td class="center"><img src="${ device.picture}" alt="设备缩略图"
										width="80px" height="80px" />
									</td>
									<td class="center">${device.deviceID}</td>
									<td  class="center" width="10%">${device.deviceName }</td>
									<td  class="center" width="10%">${depanmentlist[loop.count-1].depanmentName }</td>
									...
									<td class="center" width="8%">
										...
										<c:choose>
											...
											<c:when test="${device.status eq 1 }"><span class="label label-sm label-inverse">设备借出</span></c:when>
											<c:when test="${device.status eq 2 }"><span class="label label-sm label-warning">设备维修</span></c:when>
											<c:otherwise><span class="label label-sm label-danger">设备报废</span></c:otherwise>
										</c:choose>
									</td>
