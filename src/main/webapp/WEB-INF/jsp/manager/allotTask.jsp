		...
		<div class="main-content">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						<!-- start: PAGE TITLE & BREADCRUMB -->
						<form action="manage/allotTask.do?memberid=${memberid}" enctype="multipart/form-data" method="post">
							<table class="table table-hover" id="sample-table-1">
								...
								<tbody>
									<c:forEach items="${taskList }" var="task">
										<tr>
											<td class="center"><input type="checkbox" name="a[]"
												class="flat-grey" value="${task.name }"></td>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="col-sm-6">
										<input type="submit" value="分配" class="btn btn-blue btn-block">
									</div>
									<div class="col-sm-6">
