	...
	<div class="main-container">
		...
		<div class="main-content">
			<div class="container">
				...
				<h3>
					我当前的总工时：${f }<small>（此学年：${term.term+2015 }）</small>
				</h3>
				<div class="alert alert-warning">
					<span> 关于教师指导学生学科竞赛工作量的计算的规定与方案文档 </span><span
						class="label label-warning"><a
						href="document/软件学院关于教师指导学生学科竞赛工作量的若干规定(讨论稿2016.6.29).docx">下载文档</a></span>
				</div>
						...
						<tbody>
							<c:forEach items="${projectlist }" var="project" varStatus="loop">
								<tr>
									...
									<td class="hidden-xs">${worklist[loop.count-1].work }</td>
								</tr>
							</c:forEach>
