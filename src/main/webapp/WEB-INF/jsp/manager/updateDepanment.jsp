			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<ol class="breadcrumb">
							<li><i class="clip-home-3"></i> <a href="manage/depanmentIndex.do"> 首页</a>
							</li>
							<li >部门管理</li>
							<li >查询部门</li>
				...
				<!-- end: PAGE HEADER -->
				<!-- start: PAGE CONTENT -->
				<form role="form" class="form-horizontal" action="manage/updateDepanment.do" method="post">
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-field-1">
							部门编号 </label>
						<div class="col-sm-4">
							<input type="text"  id="form-field-1"
								class="form-control" name="depanmentID" value="${depanment.depanmentID}" readonly="true">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-field-1">
						...
						<div class="col-sm-4">
							...
							<input type="text" placeholder="部门名称" id="form-field-1"
								class="form-control" name="depanmentName" value="${depanment.depanmentName}">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-field-1">
						...
						<div class="col-sm-4">
							...
							<input type="text" placeholder="部门房间" id="form-field-1"
								class="form-control" name="depanmentRoom" value="${depanment.depanmentRoom}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							...
							<input type="text" placeholder="部门描述" id="form-field-1"
								class="form-control" name="depanmentDescribe" value="${depanment.depanmentDescribe}">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-4">
							<select name="leaderId" class="form-control search-select" id="form-field-3">
									...
									<c:forEach items="${memberList }" var="e">
										<c:choose>
											<c:when test="${member.mid eq depanment.depanmentID}">
