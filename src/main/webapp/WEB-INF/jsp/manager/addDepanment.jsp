	...
	<div class="main-container">
		...
		<div class="main-content">
			<div class="container">
				...
				<!-- end: PAGE HEADER -->
				<!-- start: PAGE CONTENT -->
				<form role="form" class="form-horizontal" action="manage/addDepanment.do" method="post">
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-field-1">
							部门名称 </label>
						<div class="col-sm-4">
							<input type="text" placeholder="部门名称" id="form-field-1"
								class="form-control" name="depanmentName">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-field-1">
						...
						<div class="col-sm-4">
							<input type="text" placeholder="部门房间" id="form-field-1"
								class="form-control" name="depanmentRoom">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" placeholder="部门描述" id="form-field-1"
								class="form-control" name="depanmentDescribe">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							...
							<div class="col-sm-6">
								<input type="submit" value="添加部门" class="btn btn-blue btn-block">
							</div>
							<div class="col-sm-6">
